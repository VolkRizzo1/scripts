...
Oracle.optionEnable = Menu.AddOptionBool({"Hero Specific","Oracle"}, "1. Enabled", "Enable Or Disable Oracle Combo Script")
...
Oracle.optionEnableKS = Menu.AddOptionBool({"Hero Specific","Oracle"}, "4. Fortunes KillSteal", "Enable Or Disable KillSteal")
--Items Toggle Menu--
Oracle.optionEnableBottle = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"1. Use Bottle on Target During Ult","Turn On/Off Bottle in Ult Combo")
Oracle.optionEnableGreaves = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"2. Use Greaves on Target During Ult","Turn On/Off Greaves in Ult Combo")
Oracle.optionEnableMekansm = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"3. Use Mekansm on Target During Ult","Turn On/Off Mekansm in Ult Combo")
Oracle.optionEnableSalve = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"4. Use Salve on Target During Ult","Turn On/Off Salve in Ult Combo")
Oracle.optionEnableUrn = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"5. Use Urn on Target During Ult","Turn On/Off Urn in Ult Combo")
Oracle.optionEnableVessel = Menu.AddOptionBool({"Hero Specific","Oracle","5. Items"},"6. Use Vessel on Target During Ult","Turn On/Off Vessel in Ult Combo")
